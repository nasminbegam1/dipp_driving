<header>
	...
	<div class="header-text"><img src="<?php echo base_url();?>images/text.jpg" alt="logo" /></div>
	<!--logo-box-->
	...
	<div class="social-box">
	    ...
	    <div class="support-email">support@di-pp.co.uk</div>
  ...
  if(isset($student_id) && $student_id != ''){
    ?>
	  ...
	  ?>
	  <li><a class="<?php echo activate_menu('learn','step',$step['id']);?>" href="<?php echo FRONTEND_URL.'learn/step/'.$step['id'];?>"><?php echo 'Stage '.($k+1).' - '.$step['name'];?></a></li>
	  <?php } ?>
    ...
    <div class="container">                
      <ul class="menu">
	<li><a <?php echo (currentClass()=='instructor' && currentMethod()=='dashboard')?'class="active"':'';?> href="<?php echo base_url().$instractorBusinessName.'/dashboard'?>">DASHBOARD</a></li>
	  ...
	  <ul>
	   ...
	   <!-- <li><a href="<?php //echo base_url().$instractorBusinessName.'/cancel-payment'?>">Payment Cancel</a></li>-->
	    <?php //} ?>
	     ...
	     <li><a href="<?php echo base_url().$instractorBusinessName.'/cancel-payment'?>">Payment Cancel</a></li>
	     <?php } ?>
	    <li><a href="<?php echo base_url().$instractorBusinessName.'/download'?>">Download Badge or Banner</a></li>
    ...
    <nav>
      <div class="container">          
	<ul class="menu">
	    <li><a class="<?php echo activate_menu('learn','index');?>" href="<?php echo FRONTEND_URL;?>">Home</a></li>
	  ...
	  <li><a <?php echo (currentClass()=='cms' && currentMethod()=='how_it_workes')?'class="active"':'';?> href="<?php echo base_url().'how-it-works'?>">How It Works</a></li>          
	  ...
	  <li><a <?php echo (currentClass()=='pass_guarantee')?'class="active"':'';?> href="<?php echo base_url().'pass_guarantee'; ?>">Pass Guarantee</a></li>
	  <li class="membership-login"><a href="<?php echo base_url().'membership-login'; ?>">Login</a></li>
	  <li><a <?php echo (currentClass()=='faq' && currentMethod()=='index')?'class="active"':'';?> href="<?php echo base_url().'faq';?>">FAQs</a></li>
	  <li><a <?php echo (currentClass()=='news' && (currentMethod()=='index' || currentMethod()=='details' ) )?'class="active"':'';?> href="<?php echo base_url().'news';?>">NEWS</a></li>
	</ul>
      </div>      
    </nav>
    <!--end nav-->
