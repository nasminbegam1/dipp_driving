...
class PaypalRecurringPaymentProfile
{
  ...
  public function __construct($api_username, $api_pasword, $api_signature, $api_version = '85.0', $env_type = 'sandbox')
  {
...
//Recurring Payments Profile Details Fields
  ...
  /*
     ...
     */
    function setExpressCheckout($nvp_params) {
        // Execute the API operation; see the PPHttpPost function above.
        $httpParsedResponseAr = $this->paypalHttpPostRequest('SetExpressCheckout', $nvp_params);
     ...
     */
    function doExpressCheckoutPayment($nvp_params) {
        // Execute the API operation; see the PPHttpPost function above.
        $httpParsedResponseAr = $this->paypalHttpPostRequest('DoExpressCheckoutPayment', $nvp_params);
        if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) {
