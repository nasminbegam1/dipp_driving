  ...
  <div class="container">
	...
	<div class="signup-box inner-box">
	  ...
	  <div class="info-form clearfix">
	    <form name="form" id="sendResetLinkIns" action="" method="post" enctype="multipart/form-data" novalidate>
	    <input type="hidden" name="action" value="Process">
	      <div class="form-box">
		<div class="input-box1">
		  <label>Email</label>
		  <input type="text" class="input" name="instructor_email" type="text" required placeholder="Please enter email address" />
		</div>                   
