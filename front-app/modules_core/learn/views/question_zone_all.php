    ...
    <div class="questionZonePan">
      <div class="lessonDetailsView">
        ...
        <div class="topTimepan">
          <div class="timeBlockPan"> <span><?php echo stripslashes($topic_name); ?>:  (<label id="no">1</label>
...
<script type="text/javascript">
		$(document).ready(function(){
				...
				$('#nxtquestion').click(function(e){ 
						...
						var ajaxUrl= base_url+'learn/practice/changeQuestionAll/';
						var postData= "action=question_all&step=next&module_id="+moduleid+"&question_id="+questionid+"&answer_id="+answerIds+"&topic_id="+topicid+"&offset="+newofset+"&is_del="+count_next_click+"&stilltoscore="+stilltoscore;;
						//alert(postData);
						...
						$.ajax({  
								...
								data: postData,
								dataType: "json",
								success: function(result){ //alert(result.module_id);
				...
				$('#prevquestion').click(function(e){
						...
						var base_url = location.protocol + '//' + location.host + '/';
						var ajaxUrl= base_url+'learn/practice/changeQuestionAll/';
						var postData= "action=question_all&step=prev&module_id="+moduleid+"&question_id="+questionid+"&topic_id="+topicid+"&offset="+ofset+"&stilltoscore="+stilltoscore;;
						//alert(postData);
						$.ajax({  
								type: "POST",  
								url: ajaxUrl,
				...
				//$('#countdown-1').timeTo(<?php echo $noofquestion*50; ?>, function(){
				$('#countdown-1').timeTo(3600, function(){
						alert('Your time has been end');
						//alert("Question Zone All");
						//alert(base_url+'learn/practice/answerResult/<?php echo $topicID; ?>/<?php echo $moduleID; ?>');
