	...
	<div class="theoryPan">
		<div class="theoryPanTop clearfix">
			...
			<div class="thPanItem clearfix">
				...
				<div class="thPanItemRt"><img src="<?php echo base_url();?>images/fbsnippet1.jpg" /></div>
			</div>
			<div class="thPanItem clearfix">
                <div class="thPanlast">
		...
		<div class="theoryPanBtm">
			<div class="theoryPanDiv clearfix">
				 <h3>STAGE1</h3>
                                <div class="theoryPanDivLt"><img src="<?php echo base_url();?>images/step1car.jpg" /></div>
			...
			<div class="theoryPanDiv clearfix">
                                <h3>STAGE2</h3> 
				<div class="theoryPanDivLt"><img src="<?php echo base_url();?>images/Step2Car.png" height="460"/></div>
				<div class="theoryPanDivRt">
			...
			<div class="theoryPanDiv clearfix">
                               <h3>STAGE3</h3>
				<div class="theoryPanDivLt"><img src="<?php echo base_url();?>images/Step3Car.png" height="460"/></div>
				<div class="theoryPanDivRt">
			...
			<div class="theoryPanDiv clearfix">
                              <h3>STAGE4</h3>
				<div class="theoryPanDivLt"><img src="<?php echo base_url();?>images/fbsnippet2.jpg" /></div>
				<div class="theoryPanDivRt">
        ...
        <div class="fooLogoPan clearfix">
            ...
            <div class="logoText">"Speak to your driving instructor today
