...
define('FRONTEND_URL',              	'http://10.33.130.5/dipp_driving/');
define('FILE_UPLOAD_ABSOLUTE_PATH',     '/var/www/html/dipp_driving/uploads/');
define('FILE_UPLOAD_URL',               'http://10.33.130.5/dipp_driving/uploads/');
...
define('BOOKING_PAYMENT',TABLE_PREFIX.'booking_payment');
