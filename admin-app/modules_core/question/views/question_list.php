        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel_controls">
                    <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL?>question/search/0/<?php echo $courseId;?>">
                        <div class="row">
                            <div class="col-sm-3">
        		  ...
        		  <tfoot>
                        ...
                        <tr <?php echo $question['class']; ?>>
                          ...
                          <td>
                              ...
                              &nbsp;<img src="<?php echo FILE_UPLOAD_URL?>question/thumbs/<?php echo $question['question_image'];?>">
                              <?php } ?>
                          </td>
