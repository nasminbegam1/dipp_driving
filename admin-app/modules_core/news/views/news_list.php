    ...
    <div class="row">
        <div class="col-sm-12">
		    ...
		    <a href="<?php echo base_url(); ?>news/add">
                            <div title="" data-placement="top auto" data-toggle="tooltip" class="addSign label label-info" data-original-title="Add News">
				...
				<th data-sort-ignore="true">Actions</th>
        		  ...
        		  <tfoot>
                        ...
                        <tbody>
                        <?php
                            foreach($news_all as $news_data) { 
                        ?>
                        <tr <?php echo $news_data['class']; ?>>
                          <td><?php echo stripslashes($news_data['title']);?></td>
                          <td><img src="<?php echo FILE_UPLOAD_URL?>news/thumbs/<?php echo $news_data['image'];?>" border="0"></td>
                          <td><a href="<?php echo $news_data['status_link'];?>" class="statusChange" style="padding-top:2px;"><span class="label <?php echo $news_data['status_class'];?>"><?php echo $news_data['status'];?></span></a></td>
                          <td>
			    <a href="<?php echo $news_data['edit_link'];?>" class="tablectrl_small bDefault tipS" title="Edit">
			      <span class="glyphicon glyphicon-edit"></span>
			    </a>
			    <a href="<?php echo $news_data['delete_link'];?>" onclick="return confirm('Are you sure you want to delete this item?');" class="tablectrl_small bDefault tipS" title="Edit">
