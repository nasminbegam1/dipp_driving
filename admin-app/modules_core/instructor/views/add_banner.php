			...
			<div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Add Instructor Banner</h4>
                    </div>
                    <div class="panel-body">
                        <form method="post" action="<?php echo base_url(); ?>instructor/banner_add" class="form-validate main parsley_reg" enctype="multipart/form-data" >
			               <input type="hidden" name="action" value="Process">
                            ...
                            <div class="form_sep">
                                ...
                                <textarea name="banner_description" class="form-control"></textarea>
                            </div>
                            <div class="form_sep">
