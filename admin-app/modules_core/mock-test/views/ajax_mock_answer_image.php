...
<div class="col-sm-6">
    ...
    <img src="<?php echo FILE_UPLOAD_URL?>mocktest_answer/thumbs/<?php echo $answer_data['mock_answer_text'];?>">
</div>
<div class="col-sm-1">
...
<input type="hidden" name="answerid[<?php echo $i;?>]" value="<?php echo $answer_data['mock_answer_id'];?>">
<input type="hidden" class="attr_val_image" name="hidden_answer_img[<?php echo $i;?>]" value="<?php echo $answer_data['mock_answer_text'];?>">
<br class="spacer">
<?php $i++;} } else {?>
<div id="content_inner">  
<div class="col-sm-6">
